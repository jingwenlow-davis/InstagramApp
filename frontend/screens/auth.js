...
export const _signInAsync = async (navigation, data) => {
  ...
  // console.log('asf', Expo.Constants.manifest.extra.url);

  fetch('https://rude-bird-15.localtunnel.me/api-token-auth/', {
    method: 'POST',
    headers: {
...
export const _signUpAsync = async (navigation, data) => {
  ...
  fetch('https://rude-bird-15.localtunnel.me/api/signup/', {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
